...
public class FrmAutor extends javax.swing.JFrame {
    ...
    private void verificarDatosVacios() {
        if (TfNombres.getText().equals("") || TfNombres.getText().length() == 0) {
            JOptionPane.showMessageDialog(this, "Por favor verifique los nombres" + " no esten vacios.", "Autor", JOptionPane.WARNING_MESSAGE);
            TfNombres.requestFocus();
        }
        if(TfApellidos.getText().equals("")||TfApellidos.getText().length()==0){
            JOptionPane.showMessageDialog(this, "Por favor verifique los apellidos" + "no esten vacios", "Autor", JOptionPane.WARNING_MESSAGE);
    ...
    private void initComponents() {
        ...
        BtnNuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/presentacion/iconos/nuevo (1).png"))); // NOI18N
        ...
        BtnGuardar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/presentacion/iconos/guardar (1).png"))); // NOI18N
        ...
        BtnEditar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/presentacion/iconos/editar (1).png"))); // NOI18N
        BtnEditar.setEnabled(false);
        ...
        BtnEliminar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/presentacion/iconos/eliminar (1).png"))); // NOI18N
        BtnEliminar.setEnabled(false);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(TbComandos, javax.swing.GroupLayout.DEFAULT_SIZE, 388, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(TbComandos, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(TbPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 342, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void BtnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGuardarActionPerformed
        ...
        if(dAutor.guardarAutor(a)){
            ...
            JOptionPane.showMessageDialog(this, "Error al guardar", "Autor", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void BtnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditarActionPerformed
        ...
        if(dAutor.editarAutor(a)){
            JOptionPane.showMessageDialog(this, "Registro Editado", "Autor", JOptionPane.INFORMATION_MESSAGE);
            llenarTabla();
            TbPanel.setSelectedIndex(1);
        }else{
